...
<body>
	...
	<nav class="navbar navbar-default navbar-static-top">
		<img align="left"
			src="/ORS_Proj0/resources/img/rayswhite.png"
			width="150" height="50">

		<div class="container-fluid">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed"
					data-toggle="" data-target="#navbar" aria-expanded="false"
					...
					<c:if test="${sessionScope.user.roleId == 1}">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<c:url value="/ctl/Marksheet/getMeritList" />"><span
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							<ul class="dropdown-menu">
								...
								<li><a href="<c:url value="/College" />"><span
										class="glyphicon glyphicon-log-out"></span> <s:message
											code="label.logout"></s:message></a></li>
								<li><a href="<c:url value="/College" />"><span
										class="glyphicon glyphicon-log-out"></span> <s:message
							...
							<ul>
								<li><a href="<c:url value="/College/search" />"><span
										class="glyphicon glyphicon-log-out"></span> <s:message
											code="label.logout"></s:message></a></li>
						</li>
					</ul>
